...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/includes/css/job-openings.css">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                // List handlers
                $('#table-list').listHandler('/Documents/job_openings.csv', 'table-list', 'table-list-header', true);
                $('.table-list-container table').tableSort('table-list-body', masterSortInfo);
    ...
    <body>
        <div id="page">
            ...
            <div id="main-content">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="table-list-container">
                                <table id="table-list-header" class="hidden-xs hidden-md">
                                    <thead></thead>
                                </table>
                                <table id="table-list">
                                    <thead></thead>
                ...
                <div id="region-one" class="job-map-bkgd">
                    <div class="container">
                        <div class="row">
                            <div id="content">
                                <div id="content-body">
                                    <div class="state-box">
                                        <div id="state-name-box"></div>
                                        <div class="state-job-list">
                                            <div class="current-job-list">
                                                <table id="current-state-job-list-header">
                                                    <thead></thead>
                                                </table>
                                                <table id="current-state-job-list-body">
                                                    <thead></thead>
                                                </table>
                                            </div>
                                            <div class="pending-job-list" class="not-currently-scrolling-list">
                                                <table id="pending-state-job-list-header">
                                                    <thead></thead>
                                                </table>
                                                <table id="pending-state-job-list-body">
                                                    <thead></thead>
                                                </table>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="job-map-region-container">
                                        <div class="job-map-container col-md-7 col-lg-8">
                                            <svg id="job-map" viewBox="0 0 922 595" preserveAspectRatio="xMidYMid meet">
                                                <g class="state">
                                            ...
                                            <div id="job-map-key">
                                                <div class="current-openings-key">
                                                    <div class="key-color"></div>
                                                    <label class="key-label">Current Openings</label>
                                                </div>
                                                <div class="pending-openings-key">
                                                    <div class="key-color"></div>
                                                    <label class="key-label">Coming Soon</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-lg-4">
                                            <div class="job-map-side-img hidden-xs hidden-sm">
                                                <img src="/includes/images/job-openings-pic.jpg">
                                            </div>
                                                ...
                                                <div class="vertically-center">
                                                    ...
                                                    <div class="btn-container">
                                                        <div class="link-btn col-sm-6">
                                                            <a class="modal-open-button map-page-btn">
                                                                <p class="btn-text">View Open Positions</p>
                                                            </a>
                                                        </div>
                                                        <div class="link-btn col-sm-6">
                                                            <a href="/Job-Seekers/Application.php" class="map-page-btn">
                        ...
                        <div class="row">
                            <div id="content">
                                <div id="content-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="bottom-col bottom-col-mid bottom-border">
                                            <div class="bottom-col-icon">
